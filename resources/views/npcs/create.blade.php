        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">Create New NPC</h2>
                </div>

                <div class="card-body">
                    <form action="{{ route('npcs.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('faction_id') is-invalid @enderror" id="faction_id" name="faction_id">
                                        ...
                                        @foreach($factions as $f)
                                            <option value="{{ $f->id }}" {{ old('faction_id') == $f->id ? 'selected' : '' }}>
                                                {{ $f->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('current_location') is-invalid @enderror" id="current_location" name="current_location" value="{{ old('current_location') }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('importance') is-invalid @enderror" id="importance" name="importance" required>
                                        <option value="minor" {{ old('importance') == 'minor' ? 'selected' : '' }}>Minor</option>
                                        <option value="supporting" {{ old('importance') == 'supporting' ? 'selected' : '' }}>Supporting</option>
                                        <option value="major" {{ old('importance') == 'major' ? 'selected' : '' }}>Major</option>
                                    </select>
                                    @error('importance')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input @error('is_public') is-invalid @enderror" id="is_public" name="is_public" value="1" {{ old('is_public') ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('appearance') is-invalid @enderror" id="appearance" name="appearance" rows="3">{{ old('appearance') }}</textarea>
                            @error('appearance')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                @foreach($attributes as $attribute)
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('attributes.' . $attribute->id) is-invalid @enderror" 
                                               ...
                                               value="{{ old('attributes.' . $attribute->id, 1) }}"
                                               min="1" max="10">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('npcs.index') }}" class="btn btn-secondary">Cancel</a>
